        ...
        <div class="card mt-5">
          <div class="card-body">
            <form class="cantTickets d-flex flex-column" action="./checkOut.php" method="POST">
              ...
              if ($row['secflyer'] != '') {
              ?>
                <img src="<?php echo 'https://lidertickets.cl' . $row['secflyer'] ?>" alt="">
              <?php
              }
              ?>
              <table>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <td class="eventResponsive">
                        <?php echo $rowTickets['name'] ?>
                        <span class="onlyResponsive" style="font-weight: 600;"><?php echo '$' . number_format($rowTickets['price'], 2) ?></span>
                        <span class="d-block eventResponsive" style="font-weight: 600; font-size: 12px"><?php echo $rowTickets['descriptionTickets'] ?></span>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
        ...
        <div class="card">
          <div class="card-body d-flex flex-column">
            <span class="flyerEvent" style="background: url('<?php echo 'https://lidertickets.cl' . $row['flyer'] ?>');  background-position: center; background-repeat: no-repeat; background-size: cover; margin: 0; width: 100%; height: 300px;"></span>
            ...
            <div id="evntListProd" class="carousel slide">
              ...
              ?>
                <div><a href="<?php echo 'https://lidertickets.cl/event.php?nomEvent=' . $rowEvents['nomEvent'] . '&id=' . $rowEvents['id'] . '&idUser' . $rowEvents['idUser'] ?>">
                    <img class="d-block w-100" src="<?php echo 'https://lidertickets.cl' . $rowEvents['flyer']  ?>" alt="<?php echo $rowEvents['nomEvent']  ?>">
                  </a>
                </div>
              <?php
              }
