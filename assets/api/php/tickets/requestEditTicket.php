...
$title = "Solcitud de edición de ticket";
$txtSucces = 'La solicitude de edición ha sido enviada satisfactoriamente';
$txtError = 'La solicitude de edición no pudo ser enviada';

$update = "UPDATE `ticketsType` SET `requestEdition`=1 WHERE `id`='" . $idTicket . "'";
