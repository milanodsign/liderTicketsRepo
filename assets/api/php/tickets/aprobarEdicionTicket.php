...
$title = "Solcitud de creacion de evento";
$idTicket = $_GET['id'];
$action = $_GET['action'];

$sql = "UPDATE `ticketsType` SET `requestEdition`='" . $action . "' WHERE `id`='" . $idTicket . "'";
$response = $mysqli->query($sql);

$txtSucces = 'La acción de realizó satisfactoriamente';
$txtError = 'El acción no pudo ser realizada';
?>
...
<body class="registerSuccess">
    ...
    <script>
        ...
        $(document).ready(function() {
            setTimeout(() => {
                location.href = "../../../../pages/requestEditTicket.php";
            }, 3000);
        });
    </script>
    <!-- Github buttons -->
