...
$txtSucces = 'El Ticket fue editado satisfactoriamente';
$txtError = 'El Ticket no pudo ser editado';

$sql = "UPDATE `ticketsType` SET `idEvent`='" . $idEvent . "',`ticketType`='" . $ticketType . "',`name`='" . $name . "',`descriptionTickets`='" . $descriptionTickets . "',`cant`='" . $cant . "',`fechaVenta`='" . $fechaVenta . "',`horaVenta`='" . $horaVenta . "',`fechaValid`='" . $fechaValid . "',`horaValid`='" . $horaValid . "',`price`='" . $price . "',`imgTickets`='" . $ticketsImg . "',`estado`='" . $estado . "', `requestEdition`=0 WHERE `id`='" . $idTicket . "'";
