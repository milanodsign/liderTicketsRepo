...
$sql = "UPDATE `user` SET `name`='" . $name . "',`mail`='" . $mail . "',`phone`='" . $phone . "',`pass`='" . $pass . "' WHERE `id`='" . $idUser . "'";
$result = $mysqli->query($sql);

$txtSucces = 'El usuario fue editado satifactoriamente.';
$txtError = 'El usuario no pudo ser editado.';
...
<body class="registerSuccess">
    ...
    <script>
        ...
        $(document).ready(function() {
            setTimeout(() => {
                location.href = "../../../../pages/editUser.php";
            }, 3000);
        });
    </script>
    <!-- Github buttons -->
