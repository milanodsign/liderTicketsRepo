                ...
                <div class="card-body">
                  <form method="POST" class="row" action="../assets/api/php/event/saveEvent.php?txt=Evento Registrado Satisfactoriamente" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select placeholder="Selecciona hasta 3 tags" class="form-control  form-control-lg select-tags pmd-select2-tags" multiple name="categoria">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input name="region" id="" class="form-control form-control-lg">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="">Comuna</label>
                      <input name="comuna" id="" class="form-control form-control-lg">
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="link" name="link" id="" class="form-control form-control-lg">
                    </div>
                    <div class="form-group col-md-4">
