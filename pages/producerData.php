                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../assets/api/php/producer/saveProducerData.php" class="row" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="div-100">
                                            ...
                                            <input class="form-control form-control-lg" type="text" size="50" name="nomProd" id="nomProd" placeholder="Escribe el nombre" spellcheck="false" data-ms-editor="true" class="valid">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="numDoc"><span class="t_ubicacion">NIT:</span></label>
                                            <input class="form-control form-control-lg" type="text" size="50" name="numDoc" id="numDoc" placeholder="Escribe el NIT" spellcheck="false" data-ms-editor="true">
                                        </div>

                                        <div class="col-md-6">
                                            <label for="nomRazonSocial"><span class="t_ubicacion">Razón Social o Nombre Completo:</span></label>
                                            <input class="form-control form-control-lg" type="text" size="50" name="nomRazonSocial" id="nomRazonSocial" placeholder="Escribe razón social" spellcheck="false" data-ms-editor="true">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="rubro"><span class="t_ubicacion">Rubro:</span></label>
                                            <input class="form-control form-control-lg" type="text" size="50" name="rubro" id="rubro" placeholder="Escribe el rubro" spellcheck="false" data-ms-editor="true">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="direccion"><span class="t_ubicacion">Dirección Comercial:</span></label>
                                            <input class="form-control form-control-lg" type="text" size="50" name="direccion" id="direccion" placeholder="Escribe la dirección" spellcheck="false" data-ms-editor="true">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="aux1" for="region">Departamento:</label>
                                            <select class="form-control form-control-lg" name="departamento" id="regionProd">
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="comuna"><span class="t_ubicacion">Municipio:</span></label>
                                            <select class="form-control form-control-lg" name="municipio" id="comunaProd">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control form-control-lg" type="tel" size="50" name="telefono" id="telefono" placeholder="Escribe el teléfono" spellcheck="false" data-ms-editor="true" >
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control form-control-lg" name="descripcion" id="descripcion" placeholder="Describe a tu productora de manera breve y precisa." spellcheck="false" data-ms-editor="true"></textarea>
                                        </div>
                                        <div class="col-md-12">
