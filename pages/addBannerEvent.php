                        ...
                        ?>
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="row" action="../assets/api/php/event/addBanner.php" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="idEvent" value="<?php echo $idEvent ?>">
                                            <div class="form-group col-md-12">
                                                <label for="">Banner del evento</label>
                                                <span class="alertBanner">Los banner deben ser en px de 1583x380</span>
                                                <input class="form-control form-control-lg" type="file" name="bannerEvent" id="imgTickets">
                                            </div>
                                            <div class="form-group col-md-12 btnSubmin d-flex justify-content-end mt-4">
                                                <input type="submit" value="Agregar Banner" class="btn btn-lg btn-primary btn-lg mb-0">
                                            </div>
                                        </form>
