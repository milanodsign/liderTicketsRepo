                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="align-items-center card-header d-flex justify-content-between pb-0">
                                    ...
                                    <input type="button" value="Solcitar Impresion de Tickets" class="btn btn-primary mb-0" onclick="requestPrintedTicketGo()">
                                </div>
                                <div class="card-body">
