                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header pb-0">
                                    <?php 
                                    $sqlEventos = "SELECT * FROM `eventos` WHERE `id`= " . $idEvent;
                                    $resultEventos = $mysqli->query($sqlEventos);
                                    while ($rowEventos = $resultEventos->fetch_array(MYSQLI_ASSOC)) {
                                        echo '<h1>Resumen de Ventas Tickets - ' . $rowEventos['nomEvent'] . '</h1>';
                                    }
                                    ?>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card mt-3">
                                ...
                                <?php 
                                    ...
                                    $resultEventos = $mysqli->query($sqlEventos);
                                    while ($rowEventos = $resultEventos->fetch_array(MYSQLI_ASSOC)) {
                                        echo '<h1>Resumen de Ventas Consumos - ' . $rowEventos['nomEvent'] . '</h1>';
                                    }
                                    ?>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card mt-3">
                                ...
                                <?php 
                                    ...
                                    $resultEventos = $mysqli->query($sqlEventos);
                                    while ($rowEventos = $resultEventos->fetch_array(MYSQLI_ASSOC)) {
                                        echo '<h1>Resumen de Ventas Boletería - ' . $rowEventos['nomEvent'] . '</h1>';
                                    }
                                    ?>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card mt-3">
                                ...
                                <?php 
                                    ...
                                    $resultEventos = $mysqli->query($sqlEventos);
                                    while ($rowEventos = $resultEventos->fetch_array(MYSQLI_ASSOC)) {
                                        echo '<h1>Resumen de Ventas Planimetría por Boletería - ' . $rowEventos['nomEvent'] . '</h1>';
                                    }
                                    ?>
                                </div>
                                <div class="card-body">
