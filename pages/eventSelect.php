                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="row" action="./salesSummaryAdmin.php" method="post" enctype="multipart/form-data">

                                        <div class="form-group col-md-12">
                                            <label for="">Seleccione Evento</label>
                                            <select class="form-control form-control-lg" name="idEvent" id="eventSelect">
                                            </select>
                                        </div>
                                        <div class="form-group col-md-12 btnSubmin d-flex justify-content-end mt-4">
                                            <input type="submit" value="Ver Balance del Evento" class="btn btn-lg btn-primary btn-lg mb-0">
                                        </div>
                                    </form>
