            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
                <div id="contentCard" class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        <div class="card-body">
                            <!-- <img src="../assets/img/cancel.png" style="max-width: 150px; margin-bottom: 1rem;"> -->
                            <span class="close"></span>
                            <h1 style="margin-bottom: 2rem; font-weight: 600; text-transform: uppercase;">La transacción no pudo ser procesada</h1>
                            <p style="margin-bottom: 2rem;">Por favor, intenta nuevamente o contacte con su banco.</p>
